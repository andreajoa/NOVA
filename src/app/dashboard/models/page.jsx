...
export default function ModelsPage() {
  ...
  const models = Object.entries(falModels.video);
  ...
  return (
    <div className="p-8 text-white min-h-screen">
      ...
      <p className="text-white/40 text-sm mb-8">{models.length} AI video models available</p>

      <div className="grid grid-cols-5 gap-4">
        {models.map(([key, model]) => {
          const m = META[key] || { badge:"", img:"/nova/nova-seedance-pro.png", accent:"#D7FF00" };
