  ...
  return (
    <main className="min-h-screen bg-[#050505] text-white">
      ...
      <div className="pt-28 pb-10 px-6 max-w-7xl mx-auto">
        ...
        <h1 className="text-5xl font-black uppercase tracking-[-0.06em] mb-3">{isPt ? "Brand Kit" : "BRAND KIT"}</h1>
        <p className="text-white/40 text-sm">{isPt ? "Cores, fontes e assets da sua marca." : "Your brand colors, fonts and assets."}</p>
