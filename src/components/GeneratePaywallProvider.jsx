...
export default function GeneratePaywallProvider() {
  ...
  return (
    <div className="fixed inset-0 z-[9999] overflow-y-auto bg-black/85 px-4 py-4 backdrop-blur-md sm:py-6 lg:py-8">
      <div className="flex min-h-full items-start justify-center sm:items-center">
        <div className="relative my-auto w-full max-w-[760px] overflow-hidden rounded-[28px] border border-[#D7FF00]/45 bg-[#070707] shadow-[0_0_100px_rgba(215,255,0,.22)]">
          ...
          <button
            ...
            className="absolute right-4 top-4 z-20 grid h-9 w-9 place-items-center rounded-full border border-white/10 bg-black/30 text-white/45 transition hover:bg-white/10 hover:text-white"
            aria-label="Close"
          >
            ×
          </button>

          <div className="relative z-10 max-h-[calc(100dvh-32px)] overflow-y-auto p-5 sm:max-h-[calc(100dvh-48px)] sm:p-7 lg:max-h-[calc(100dvh-64px)] lg:p-8">
            <div className="mb-4 inline-flex rounded-full bg-[#D7FF00] px-3 py-1 text-[10px] font-black uppercase tracking-[.18em] text-black">
              Your video is ready to render
            </div>

            <h2 className="max-w-2xl text-[34px] font-black uppercase leading-[0.96] tracking-tight text-white sm:text-[44px] lg:text-[52px]">
              Don’t leave your AI video unfinished.
            </h2>

            <p className="mt-4 max-w-2xl text-sm leading-6 text-white/55 sm:text-[15px]">
              Your prompt is ready. NOVA calculated the render, but starter credits are only for exploring the studio. Upgrade to unlock full video generation.
            </p>

            <div className="mt-5 grid gap-3 rounded-2xl border border-white/10 bg-white/[.035] p-4 sm:grid-cols-3">
              <div>
            ...
            <p className="mt-4 text-xs leading-5 text-white/35 sm:text-[13px]">
              Video generation uses {creditsPerSecond} credits per second. A {seconds}-second video needs {required} credits. Upgrade now and continue from where you stopped.
            </p>
            ...
            <div className="mt-6 grid gap-3 md:grid-cols-2">
              ...
              >
                ...
                <div className="mt-1 text-xs font-bold leading-5 text-black/60">
              ...
              >
                ...
                <div className="mt-1 text-xs font-bold leading-5 text-white/40">
